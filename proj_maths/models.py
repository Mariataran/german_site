...
class Lists(models.Model):
    ...
    word = models.ForeignKey('Terms', models.DO_NOTHING, db_column='word', to_field='name')
...
class VerbsForms(models.Model):
    ...
    fid = models.OneToOneField(Terms, models.DO_NOTHING, db_column='fid', primary_key=True)
